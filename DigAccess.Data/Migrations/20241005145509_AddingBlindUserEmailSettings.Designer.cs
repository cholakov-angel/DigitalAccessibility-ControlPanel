...
namespace DigAccess.DbContext.Migrations
{
    ...
    [Migration("20241005145509_AddingBlindUserEmailSettings")]
    partial class AddingBlindUserEmailSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.BlindUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.BlindUserEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.BlindUserLicence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.EmailSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.BlindUserEmail", b =>
                {
                    b.HasOne("DigAccess.Data.Entities.BlindUser", "BlindUser")
                        .WithMany()
                        .HasForeignKey("BlindUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigAccess.Data.Entities.EmailSettings", "EmailSettings")
