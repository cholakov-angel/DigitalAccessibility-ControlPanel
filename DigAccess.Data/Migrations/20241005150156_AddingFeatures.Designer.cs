...
namespace DigAccess.DbContext.Migrations
{
    ...
    [Migration("20241005150156_AddingFeatures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.BlindUserFeature", b =>
                {
                    b.Property<Guid>("BlindUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.Feature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.BlindUserFeature", b =>
                {
                    ...
                    b.HasOne("DigAccess.Data.Entities.Feature", "Feature")
                        .WithMany()
