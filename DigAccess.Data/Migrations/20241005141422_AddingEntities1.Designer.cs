...
namespace DigAccess.DbContext.Migrations
{
    ...
    [Migration("20241005141422_AddingEntities1")]
    partial class AddingEntities1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.Office", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.Organisation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigAccess.Data.Entities.Office", b =>
                {
                    ...
                    b.HasOne("DigAccess.Data.Entities.Organisation", "Organisation")
                        .WithMany("Offices")
