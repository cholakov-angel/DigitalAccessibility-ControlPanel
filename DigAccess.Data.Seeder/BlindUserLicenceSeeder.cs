...
{
    public class BlindUserLicenceSeeder : IEntityTypeConfiguration<BlindUserLicence>
    {
        public async void Configure(EntityTypeBuilder<BlindUserLicence> builder)
        {
            builder.HasData(new BlindUserLicence()
            {
