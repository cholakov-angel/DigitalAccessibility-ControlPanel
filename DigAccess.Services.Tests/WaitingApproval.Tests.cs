...
namespace DigAccess.Services.Tests
{
    ...
    public class WaitingApproval
    {
        ...
        public async Task GetOffices()
        {
            ...
            var result = await waitingApprovalService.GetOffices("c5e270c8-df31-40ec-938e-d1300457f3ef");
        ...
        public async Task GetOrganisations()
        {
            ...
            var result = await waitingApprovalService.GetOrganisations();

            Assert.That(result.Count, Is.EqualTo(2));
        }

        [Test]
        public async Task GetOfficesFromOrganisations()
        {
            WaitingApprovalService waitingApprovalService = new WaitingApprovalService(context, userManager);

            var result = await waitingApprovalService.OfficeSelect("c5e270c8-df31-40ec-938e-d1300457f3ef");
            Assert.That(result.Offices.Count, Is.EqualTo(3));
        }

        [Test]
        public async Task GetOfficesFromOrganisationsInvalid()
        {
            WaitingApprovalService waitingApprovalService = new WaitingApprovalService(context, userManager);
        ...
        [Test]
        public async Task SetOrganisationForUserInvalidModels()
        {
            WaitingApprovalService waitingApprovalService = new WaitingApprovalService(context, userManager);
